...
export function Contact() {
    ...
    const contacts = [
        {
            name: "WattsApp",
            description: "+55 13 99155-8577",
            link: "https://wa.me/5513991558577?text=Olá...",
            icon: <FaWhatsapp className="h-10 w-10" />
        },
        {
            name: "Email",
            description: "renato.matosoliv@gmail.com",
            link: "https://renato.matosoliv@gmail.com",
          ...
          <div className="basis-2/3">
            <form ref={form} onSubmit={sendEmail}>
              ...
              <div>
                <button
                  type="submit"
                  className="button flex items-center bg-white p-2 gap-2 text-blue-700"
                  disabled={loading}
                >
