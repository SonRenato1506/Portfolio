...
export function Skills () {
    const educations = [
        {
            name: "Curso de Desenvolvimente Web Full Stack | RocketSeat",
        },
        {
            name: "Curso de HTML e CSS | Curso em vídeo"
        },
        {
            name: "Curso de Lógica de Programação | Curso em Vídeo"
        },
        {
            name: "Curso de JavaScript | Curso em Vídeo"
        },
        {
            name: "Curso básico de Hardware | Settaport"
        }
    ]
